...
$(function() {
	...
	function getData() {
		...
		$.ajax({
			type : "GET",
			url : "<?= $Path;?>/sched/order/reject-list",
            data: {
				actKey : actKey
            },
			dataType : "json",
