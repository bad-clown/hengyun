            ...
            success : function(d) {
                ...
                if(data.list.length) {
                    ...
                    $.each(data.list, function(i,o) {
                        ...
                        var h = '<tr><td>'+ o.phone +'</td><td align="center"><div class="form-group"><label>'+type[o.type]+'</label></div></td><td align="center">'+t+'</td><td width="250"><a class="btn-info" href="#">查看详情</a><a class="btn-danger j-delete" href="javascript:;" data-key="'+o._id+'">删除</a></td></tr>';
                        c.append(h)
                    })
                }
                else {
