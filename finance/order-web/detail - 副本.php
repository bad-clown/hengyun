...
$(function() {
	$.ajax({
		...
		success : function(data) {
			...
			var extraHTML = '<div class="clearfix" id="J-order-detail"><div class="form-group '+hasBidWarning+'"><label class="control-label">后台报价</label><input class="form-control" readonly="readonly" name="bidPrice" value="'+ bidPrice +'" type="text"></div><div class="form-group '+hasBidWarning+'"><label class="control-label">后台报价合计</label><input class="form-control" readonly="readonly" name="bidPriceTotal" value="'+ bidPriceTotal +'" type="text"></div><div class="form-group '+hasDriverWarning+'"><label class="control-label">司机报价</label><input class="form-control" readonly="readonly" name="driverBid" value="'+ driverBid +'" type="text"></div><div class="form-group '+hasDriverWarning+'"><label class="control-label">司机报价合计</label><input class="form-control" readonly="readonly" name="driverBidTotal" value="'+ driverBidTotal +'" type="text"></div><div class="form-group"><label class="control-label">代付费</label><input class="form-control" name="" readonly="readonly" value="'+(data.daifu || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">预期税点(%)</label><input class="form-control" name="predictTax" readonly="readonly" value="5" type="text"></div><div class="form-group"><label class="control-label">预期毛利润</label><input class="form-control" name="predictProfit" readonly="readonly" value="'+(data.predictProfit || '')+'" type="text"></div><div class="form-group"><label class="control-label">预期利润率</label><input class="form-control" name="predictProfitRate" readonly="readonly" value="'+(data.predictProfitRate || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">分出单价</label><input class="form-control" name="outPrice" readonly="readonly" value="'+(data.outPrice || '')+'" type="text"></div><div class="form-group"><label class="control-label">分出额</label><input class="form-control" name="outMoney" readonly="readonly" value="'+(data.outMoney || '')+'" type="text"></div><div class="form-group"><label class="control-label">分出一口价</label><input class="form-control" name="outBidPrice" readonly="readonly" value="'+(data.outBidPrice || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">实际税点(%)</label><input class="form-control" name="tax" readonly="readonly" value="'+(data.tax || '')+'" type="text"></div><div class="form-group"><label class="control-label">实际毛利润</label><input class="form-control" name="realProfit" readonly="readonly" value="'+(data.realProfit || '')+'" type="text"></div><div class="form-group"><label class="control-label">实际毛利润率</label><input class="form-control" name="realProfitRate" readonly="readonly" value="'+(data.realProfitRate || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">是否开票</label><input class="form-control" name="billing" readonly="readonly" value="'+(data.billing || '')+'" type="text"></div><div class="form-group"><label class="control-label">开票日期</label><input class="form-control" name="bilingTime" id="bilingTime" readonly="readonly" value="'+bilingTime+'" type="text"></div><div class="form-group"><label class="control-label">回单时间</label><input class="form-control" name="backTime" id="backTime" readonly="readonly" value="'+backTime+'" type="text"></div><div class="form-group"><label class="control-label">回单是否收到</label><input class="form-control" name="" readonly="readonly" value="'+(data.backReceived || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">收款状态</label><input class="form-control" name="receiveMoneyTime" readonly="readonly" value="'+(data.receiveMoneyTime || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">付款状态</label><input class="form-control" name="payedStatus" readonly="readonly" value="'+(data.payedStatus || '')+'" type="text"></div><div class="form-group"><label class="control-label">付款时间</label><input class="form-control" name="payTime" id="payTime" readonly="readonly" value="'+payTime+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">付款方式：油卡</label><input class="form-control" name="payType" readonly="readonly" value="'+(data.payOilAmount || '')+'" type="text"></div></div>' +
				'<div class="clearfix"><div class="form-group"><label class="control-label">付款方式：网银</label><input class="form-control" name="payType" readonly="readonly" value="'+(data.payNetAmount || '')+'" type="text"></div></div>';
	...
	function profit() {
		var totalWeight = parseFloat($('input[name="totalWeight"]').val()),
			...
			predictTax = parseFloat($('input[name="predictTax"]').val()),
		...
		if(bidPriceTotal && driverBidTotal && iOutMoney) {
			console.log(bidPriceTotal)
			console.log(driverBidTotal)
			console.log(iOutMoney)
